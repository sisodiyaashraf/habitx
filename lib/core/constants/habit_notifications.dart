class HabitNotifications {
  ...
  static const List<String> flirty = [
    "Aaj bhi miss kar diya? Wait kar rahi thi tumhara 😏",
    "Thoda time nikaalo mere liye, matlab apni habit ke liye 😉",
    "Consistency sexy hoti hai, pata hai na? 😘",
    "Jitna ignore karoge, utna hi pareshan karungi 🫣",
    "Ek baar kar ke dekho, addict ho jaoge mere jaise 💋",
    "Roz milne ka wada tha na? Nibhao zara 🌹",
    "Aaj bhi late aaoge kya mujhse milne? ⏰",
    ...
    "Aaj bhi bhaav kha rahe ho mujhe? 😏",
  ];
  ...
  static const List<String> roast = [
    "Wah! Fir se skip? Records bana rahe ho kya? 🙄",
    "Motivation dhoondhne gaya, wapas hi nahi aaya 🥱",
    "Kal se start karunga - 47th baar sun raha hoon 🤡",
  ...
  static const List<String> cute = [
    "Babu, aaj wali habit bhool gaye kya? 🥺",
    "Ek chhota kaam hai shona, kar lo na please 🥹",
    "Pyaari si yaad dilaane wali reminder 💕",
    "Chalo uth jao, streak todna mana hai! 🧸",
    "Shona please, sirf 5 minute ka kaam hai 🌸",
    ...
    "Chhoti si request hai babu, maan lo na 🥺",
  ];
  ...
  static const List<String> motivational = [
    ...
    "Winners roz dikhte hain, excuses nahi dete 🏆",
  ];
  ...
  static const List<String> breakup = [
    ...
    "Wapas aane ka wait kar rahi thi, bhool gaye 🥀",
    ...
    "Itni jaldi bhool gaye humara roz ka wada? 😔",
    "Main abhi bhi wait kar rahi hoon tumhara ⌛",
  ];
  ...
  static const List<String> discipline = [
    ...
    "Aaj miss mat karo, kal khud ko thank karoge ⏳",
